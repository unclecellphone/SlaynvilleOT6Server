...
class RuneSpell final : public Action, public Spell
{
	public:
		...
		bool executeUseLate(uint32_t playerCid, const Position& fromPos, uint32_t itemID, uint32_t targetCid, const Position& toPosition, bool isHotkey);
