...
using RuneUseMap = std::map<int32_t, Item*>;
static RuneUseMap runeItemMap;
class Actions final : public BaseEvents
{
	public:
		...
		static int32_t registerRune(Item* rune);
		static bool deregisterRuneId(int32_t id);
		static Item* getRune(int32_t id);
	...
	private:
		...
		void clearRuneMap(RuneUseMap& map, bool fromLua);
