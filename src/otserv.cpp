...
void printServerVersion()
{
	...
	std::cout << "Compiled on " << __DATE__ << ' ' << __TIME__ << std::endl;  //" for platform ";
	std::cout << std::endl;
	...
	std::cout << "downgraded to 7.X by nekiro" << std::endl;
	std::cout << "downgraded to 6.X by unclecellphone" << std::endl;
	std::cout << "in honor of the homie matt/starscream/slayn, rip" << std::endl;
	std::cout << std::endl;
