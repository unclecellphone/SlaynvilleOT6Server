...
static constexpr auto STATUS_SERVER_NAME = "slaynville";
static constexpr auto STATUS_SERVER_VERSION = "Hokuten's 6.X downgrade";
static constexpr auto STATUS_SERVER_DEVELOPERS = "unclecellphone and the gang";
