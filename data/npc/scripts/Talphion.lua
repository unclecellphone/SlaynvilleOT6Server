...
function creatureSayCallback(cid, type, msg)
	...
	elseif msgcontains(msg, 'heal') and getCreatureCondition(cid, CONDITION_FIRE) == true then
	npcHandler:say("YOU ARE BURNING! THAT\'S FUN, HOW DO YOU DO THAT?", cid)
	doRemoveCondition(cid, CONDITION_FIRE)
    doSendMagicEffect(getCreaturePosition(cid), 14)
	
	elseif msgcontains(msg, 'heal') and getCreatureCondition(cid, CONDITION_POISON) == true then
