...
function creatureSayCallback(cid, type, msg)
	...
	talk_state = 0
	elseif msgcontains(msg, 'kiss') and getCreatureCondition(cid, RETURNVALUE_PLAYERISPZLOCKED) == true then
	...
	npcHandler:say("So, you have managed to pass the seal of the 1 path. Have you passed any other seal yet?", cid)
	talk_state = 7
	elseif msgcontains(msg, 'yes') and talk_state == 6 and quinto_selo == -1 then
	npcHandler:say("You have not found your 1 path yet. Return when you are better prepared.", cid)
	talk_state = 0
	...
	talk_state = 8
	elseif msgcontains(msg, 'yes') and talk_state == 7 and sexto_selo == -1 then
	npcHandler:say("You have not found your 1 path yet. Return to meh when you are better prepared.", cid)
	talk_state = 0
