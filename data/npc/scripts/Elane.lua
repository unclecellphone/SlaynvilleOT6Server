...
npcHandler:say("I sell 'find person', 'light', 'create food', 'light healing', 'light magic missile', 'antidote', 'intense healing', 'conjure arrow', 'great light', 'heavy magic missile', 'magic shield' and. ...", cid)
npcHandler:say("'fireball', 'poison arrow', 'destroy field', 'ultimate healing', 'explosive arrow' and 'invisible'.", cid)
talk_state = 0

elseif msgcontains(msg, 'missile') or msgcontains(msg, 'Missile') then
npcHandler:say("Paladins are the best missile fighters in Tibia!", cid)
talk_state = 0
