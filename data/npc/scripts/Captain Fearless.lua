...
function creatureSayCallback(cid, type, msg)
	...
	if msgcontains(msg, 'darashia') then
		npcHandler:say('I warn you! Do you really want to go there?  I am fearless!', cid)
		talk_state = 2
	elseif msgcontains(msg, 'yes') and talk_state == 2 then
		npcHandler:say('Heh... a passage to Darashia for 60 gold?', cid)
		talk_state = 3
	elseif msgcontains(msg, 'yes') and talk_state == 3 then
		selfSay("I changed my mind.  I'm... scared")
		
	elseif msgcontains(msg, 'no') and talk_state == 2 then
		npcHandler:say('I thought so! I am fearless!  But you are scared...', cid)
		talk_state = 0	
	end
