...
function creatureSayCallback(cid, type, msg) msg = string.lower(msg)
	...
	if getPlayerVocation(cid) == 2 or getPlayerVocation(cid) == 6 then
		...
		npcHandler:say("Sorry, I only sell spells to druids.", cid)
		return false
		end
	end
--name the spell--
...
npcHandler:say("I sell 'Find Person', 'Light', 'Create Food', 'Light Healing', 'Light Magic Missile', 'Antidote', 'Intense Healing', 'Poison Field', 'Great Light', 'Fire Field', 'Heavy Magic Missile', 'Magic Shield', 'Intense Healing Rune', 'Antidote Rune' and. ...", cid)
npcHandler:say("'Fireball', 'Energy Field', 'Destroy Field', 'Ultimate Healing', 'Great Fireball', 'Firebomb', 'Creature Illusion', 'Convince Creature', 'Ultimate Healing Rune', 'Chameleon', 'Explosion' and. ...", 5)
npcHandler:say("'Invisible', and 'Summon Creature'.", 9)
talk_state = 0	
