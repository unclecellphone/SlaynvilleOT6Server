...
keywordHandler:addKeyword({'spell'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "I have 'Magic Rope', 'Levitate', 'Haste', 'Berserk', 'Force Strike', 'Energy Strike', and 'Flame Strike'."})
...
elseif msgcontains(msg, 'berserk') or msgcontains(msg, 'Berserk') then
	...
	spellmagiclevel = 5
		...
		npcHandler:say("I am sorry but this spell is only for knights.", cid)
		talk_state = 0
		end		
