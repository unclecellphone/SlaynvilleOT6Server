...
if msgcontains(msg, 'beasts') or msgcontains(msg, 'Beasts') or msgcontains(msg, 'orc') or msgcontains(msg, 'them') or msgcontains(msg, 'raid') or msgcontains(msg, 'Orc') then
	npcHandler:say("These green, orcish raiders come in masses. Hundreds of them. They are worse than those goblins I have to deal with from time to time. ...", cid)
...
elseif msgcontains(msg, 'mission') or msgcontains(msg, 'Mission') or msgcontains(msg, 'quest') or msgcontains(msg, 'Quest') then
	npcHandler:say("Well, I cannot provide you with a mission, I have a mission to fulfill myself. ...", cid)
...
elseif msgcontains(msg, 'amazon') or msgcontains(msg, 'Amazon') then
	npcHandler:say("I see you have heard of amazons before. Well let me tell you, probably everything you heard is true. We are much stronger and tougher than people think. Also, we know how to fight and could teach many men how to handle a weapon. ...", cid)
