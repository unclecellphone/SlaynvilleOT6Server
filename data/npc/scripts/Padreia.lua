...
function creatureSayCallback(cid, type, msg)
	...
	if getPlayerVocation(cid) == 2 or getPlayerVocation(cid) == 6 then
		...
		npcHandler:say("Sorry, I only teach druids!", cid)
		return false
		end
	end
...
elseif msgcontains(msg, 'spell') then
	...
	npcHandler:say("'Fire Wave', 'Ultimate Healing', 'Great Fireball', 'Firebomb', 'Energy Beam', 'Creature Illusion', 'Explosion', 'Great Energy Beam', 'Invisible', 'Summon Creature', 'Energy Wave' and 'Sudden Death'.", 5)
	talk_state = 0
