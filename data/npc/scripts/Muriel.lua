...
npcHandler:say("Sorry, I only sell spells to sorcerers!", cid)
talk_state = 0
end
...
npcHandler:say("In a spellbook, your spells are listed. There you can find the pronunciation of each spell. Do you want to buy one for 150 gold?", cid)
talk_state = 814
...
npcHandler:say("I sell 'Find Person', 'Light', 'Light Healing', 'Light Magic Missile', 'Antidote', 'Intense Healing', 'Poison Field', 'Great Light', 'Fire Field', 'Heavy Magic Missile', 'Magic Shiel', 'Fireball', 'Energy Field', 'Destroy Field', 'Fire Wave' and. ...", cid)
npcHandler:say("'Ultimate Healing', 'Great Fireball', 'Firebomb', 'Energy Beam', 'Creature Illusion', 'Explosion', 'Great Energy Beam', 'Invisible', 'Summon Creature', 'Energy Wave' and 'Sudden Death'.", 5)
talk_state = 0
	
elseif msgcontains(msg, 'rune') or msgcontains(msg, 'Rune') then
npcHandler:say("Each spell, that starts with 'Ad', needs a rune. You have to hold a blank rune in one of your hands when you cast it. You can buy runes at the magic shop.", cid)
talk_state = 0
