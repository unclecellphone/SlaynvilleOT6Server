...
function creatureSayCallback(cid, type, msg)
	...
	if getPlayerVocation(cid) == 1 or getPlayerVocation(cid) == 5 then
		...
		npcHandler:say("... Only sorcerers...", cid)
		return false
		end
	end
...
npcHandler:say("... I teach for.. 'find person', 'light', 'light healing', 'light magic missile', 'antidote', 'intense healing', 'poison field', 'great light', 'fire field', 'heavy magic missile', 'magic shield', 'fireball', 'energy field', 'destroy field' and. ...", cid)
