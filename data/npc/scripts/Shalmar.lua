...
if msgcontains(msg, 'find person') or msgcontains(msg, 'Find person') then
	...
	spellmagiclevel = 0
		...
		npcHandler:say("I am sorry but this spell is only for all vocations.", cid)
		talk_state = 0
		end
...
elseif msgcontains(msg, 'create food') or msgcontains(msg, 'Create food') then
	...
	spellmagiclevel = 0
		...
		npcHandler:say("I am sorry but this spell is only for druids and paladins.", cid)
		talk_state = 0
		end	
...
elseif msgcontains(msg, 'rune') then
	npcHandler:say("I don't sell this anymore, it sort of kept on confusing me to do that much work. Please talk to my assistant Asima in the next room to purchase magic goods.", cid)
	talk_state = 0
	...
	if getPlayerVocation(cid) == 1 or getPlayerVocation(cid) == 2 or getPlayerVocation(cid) == 5 or getPlayerVocation(cid) == 6 then
		...
		npcHandler:say("Sorry, I only teach sorcerers and druids!", cid)
		return false
		end
	end
...
elseif msgcontains(msg, 'spell') then
	...
	npcHandler:say("for you, I sell 'Find Person', 'Light', 'Light Healing', 'Light Magic Missile', 'Antidote', 'Intense Healing', 'Poison Field', 'Great Light', 'Fire Field', 'Heavy Magic Missile', 'Magic Shield', 'Fireball', 'Energy Field', 'Destroy Field' and. ...", cid)
	npcHandler:say("'Fire Wave', 'Ultimate Healing', 'Great Fireball', 'Firebomb', 'Energy Beam', 'Creature Illusion', 'Explosion', 'Great Energy Beam', 'Invisible', 'Summon Creature', 'Energy Wave' and 'Sudden Death'.", cid)
	talk_state = 0
	
	elseif getPlayerVocation(cid) == 2 or getPlayerVocation(cid) == 6 then
	npcHandler:say("for you, I sell 'Find Person', 'Light', 'Create Food', 'Light Healing', 'Light Magic Missile', 'Antidote', 'Intense Healing', 'Poison Field', 'Great Light', 'Fire Field' and. ...", cid)
	...
	npcHandler:say("'Chameleon', 'Explosion', 'Invisible', and 'Summon Creature'.", 9)
	talk_state = 0
	end
