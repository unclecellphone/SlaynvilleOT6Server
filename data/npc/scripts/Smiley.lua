...
npcHandler:say("... sell to... Only druids..", cid)
talk_state = 0
end	
...
npcHandler:say("... I teach... 'Find Person', 'Light', 'Create Food', 'Light Healing', 'Ligh Magic Missile', 'Antidote', 'Intense Healing', 'Poison Field', 'Great Light', 'Fire Field', 'Heavy Magic Missile', 'Magic Shield', 'Intense Healing Rune', 'Fireball' and. ...", cid)
npcHandler:say("'Energy Field', 'Destroy Field', 'Ultimate healing', 'Great Fireball', 'Firebomb', 'Creature Illusion', 'Convince Creature', 'Ultimate Healing Rune', 'Chameleon', 'Explosion', 'Invisible', and 'Summon Creature'.", 5)
talk_state = 0	
