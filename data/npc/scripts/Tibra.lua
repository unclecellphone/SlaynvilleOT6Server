...
elseif msgcontains(msg, 'name') or msgcontains(msg, 'Name') then
	npcHandler:say("My name is Tibra. Your soul tells me that you are ".. getPlayerName(cid) .."", cid)
	talk_state = 0

elseif talk_state == 3 and msgcontains(msg, 'yes') or talk_state == 3 and msgcontains(msg, 'Yes') then	
	npcHandler:say("So what does trouble your soul, pilgrim?", cid)
	talk_state = 4
elseif talk_state == 3 and msgcontains(msg, '') then	
	npcHandler:say("As you wish.", cid)
	talk_state = 0
elseif talk_state == 4 and msgcontains(msg, '') then	
	npcHandler:say("Meditate on that and try harder to improve soul.", cid)
	talk_state = 0
...
elseif talk_state == 1 and msgcontains(msg, 'yes') then
	...
	npcHandler:say("May Daraman guide your quest for ascension.", cid)
...
elseif talk_state == 1 and msgcontains(msg, '') then
	...
	npcHandler:say("Do you whish to confess your sins, my chilid?", cid)
	topic = 3
