...
if msgcontains(msg, 'aneus') or msgcontains(msg, 'Aneus') then
	npcHandler:say("A very nice person. He has a great story to tell with big fights and much magic. Just ask him for his story. ...", cid)
...
elseif msgcontains(msg, 'seamonster') or msgcontains(msg, 'Seamonster') then
	npcHandler:say("Only some days ago I was at the docks late in the night and was looking for my husband's ship when suddenly a known noise appeared near the docks. ...", cid)
...
elseif msgcontains(msg, 'rumour') or msgcontains(msg, 'Rumour') then
	npcHandler:say("Well, I heard about evil beings living in a dungeon below us. So once I tried to find them and went down the hole far to the southwest. ...", cid)
