...
elseif msgcontains(msg, 'spell') or msgcontains(msg, 'Spell') then
	...
	npcHandler:say("For you my friend, I sell 'Find Person', 'Light', 'Light Healing', 'Antidote' and 'Great Light'.", cid)
	elseif getPlayerVocation(cid) == 3 or getPlayerVocation(cid) == 7 then
	npcHandler:say("For you my friend, I sell 'Find Person', 'Light', 'Create Food', 'Light Healing', 'Light Magic Missile', 'Antidote', 'Intense Healing', 'Conjure Arrow', 'Great Light', 'Heavy Magic Missile', 'Magic Shield' and. ...", cid)
