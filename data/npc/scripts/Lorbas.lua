...
if msgcontains(msg, 'vanity') or msgcontains(msg, 'Vanity') then
	npcHandler:say("In our vanity we thought that we could impress the gods with our money and show piety by building them a monument. ...", cid)
...
elseif msgcontains(msg, 'cathedral') or msgcontains(msg, 'Cathedral') then
	npcHandler:say("What was once planned as the most impressive cathedral of all times, lies now in ruins. ...", cid)
