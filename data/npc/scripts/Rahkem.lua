...
function creatureSayCallback(cid, type, msg) msg = string.lower(msg)
	...
	elseif msgcontains(msg, 'spell') then
		if getPlayerVocation(cid) == 1 or getPlayerVocation(cid) == 5 then
			...
			NPCSay("'Fire Wave', 'Ultimate Healing', 'Great Fireball', 'Firebomb', 'Energy Beam', 'Creature Illusion', 'Explosion', 'Great Energy Beam', 'Invisible', 'Summon Creature', 'Energy Wave' and 'Sudden Death'.", 5)
			talk_state = 0
		elseif getPlayerVocation(cid) == 2 or getPlayerVocation(cid) == 6 then
			...
			NPCSay("'Chameleon', 'Explosion', 'Invisible', and 'Summon Creature'.", 9)
			talk_state = 0
		end
	end
