...
addTravelKeyword('ab\'dendriel', 70, BOATPOS_AB)
addTravelKeyword('carlin', 110, BOATPOS_CARLIN)
addTravelKeyword('cormaya', 20, BOATPOS_CORMAYA)
addTravelKeyword('thais', 160, BOATPOS_THAIS)
addTravelKeyword('venore', 40, BOATPOS_VENORE)
