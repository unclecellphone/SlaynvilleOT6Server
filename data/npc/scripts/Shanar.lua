...
keywordHandler:addKeyword({'spell'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "I teach 'Poison Field', 'Fire Field', 'Energy Field'."})
...
npcHandler:say("I'm sorry, but I only sell spells for druids.", cid)
talk_state = 0
end
