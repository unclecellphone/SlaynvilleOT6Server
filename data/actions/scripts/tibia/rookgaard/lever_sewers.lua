function onUse(cid, item, fromPosition, itemEx, toPosition)
	...
	if item.itemid == 1945 then
		doCreateItem(1284, 1, posBridge[1])
		doCreateItem(1284, 1, posBridge[2]) 
		for i=1,#switches do
	...
	elseif item.itemid == 1946 then
		...
		doCreateItem(493, 1, posBridge[1])
		doCreateItem(493, 1, posBridge[2])
		doCreateItem(4799, 1, posBridge[1])
		doCreateItem(4797, 1, posBridge[2])	
		doTransformItem(item.uid,item.itemid-1)
